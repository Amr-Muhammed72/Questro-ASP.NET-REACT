          ...
          <div className="flex-1 relative hidden lg:flex items-center justify-center h-[600px] w-full max-w-lg" style={{ perspective: "2000px" }}>
            ...
            {isLoading || displayMedia.length < 3 ? (
              <div className="relative w-full h-full flex items-center justify-center animate-pulse">
                <div className="absolute bottom-[5%] left-[-5%] w-[200px] h-[300px] rounded-2xl bg-white/5 border border-white/10 z-10 transform -rotate-12" />
                <div className="absolute top-[0%] right-[-5%] w-[220px] h-[320px] rounded-2xl bg-white/5 border border-white/10 z-20 transform rotate-6" />
                <div className="relative z-30 w-[300px] h-[450px] rounded-2xl bg-white/5 border border-white/10" />
              </div>
            ) : (
              <motion.div

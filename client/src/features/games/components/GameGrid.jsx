...
const GameGrid = memo(({
  fetchPage, // async (page) => array of games
  // Legacy props kept for fallback if fetchPage is not provided by parent
  games: initialGames = [],
  ...
  useEffect(() => {
    if (!fetchPage) {
       setCurrentData(initialGames);
       setIsLoading(externalLoading);
       setError(externalError);
       setCurrentPage(externalPage);
       setHasNextPage(initialGames.length === PAGE_SIZE);
    }
  }, [initialGames, externalLoading, externalError, externalPage, fetchPage]);

...
const DiscoverHeader = memo(({ isGame, searchInput, handleSearchChange, onSearchSubmit }) => {
  return (
    <div className="flex flex-col space-y-4 text-center">
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-white drop-shadow-lg leading-tight">
        Discover The Perfect {isGame ? 'Game' : 'Film'} <br className="hidden sm:block" /> With An Effortless Search And Selection
      </h1>

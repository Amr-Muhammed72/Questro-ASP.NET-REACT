...
public class UserMovieRatesByUserSpecification : BaseSpecification<UserMovieRate>
{
    public UserMovieRatesByUserSpecification(long userId, int pageIndex, int pageSize)

...
namespace Questro.Infrastructure.Migrations
{
    ...
    [Migration("20260612210854_AddFFamilyManagement")]
    partial class AddFFamilyManagement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Questro.Core.Entities.UserManagement.ChildRestriction", b =>
                {
                    ...
                    b.Property<string>("AllowedGameGenreIds")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AllowedMovieGenreIds")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

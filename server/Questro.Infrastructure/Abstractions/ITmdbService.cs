...
public interface ITmdbService
{
    ...
    Task<TmdbPagedMovieResponse?> DiscoverMoviesAsync(MovieSpecParams specParams, CancellationToken cancellationToken = default);
    Task<TmdbPagedMovieResponse?> SearchMoviesAsync(MovieSpecParams specParams, CancellationToken cancellationToken = default);

...
public interface IRawgService
{
    ...
    Task<RawgPagedGameResponse?> DiscoverGamesAsync(GameSpecParams specParams, bool isChildAccount = false, CancellationToken cancellationToken = default);
    Task<RawgPagedGameResponse?> SearchGamesAsync(GameSpecParams specParams, bool isChildAccount = false, CancellationToken cancellationToken = default);
